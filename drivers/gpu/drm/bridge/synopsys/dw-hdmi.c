...
static __maybe_unused const u16 csc_coeff_rgb_full_to_eitu601_full[3][4] = {
...
static __maybe_unused const u16 csc_coeff_rgb_full_to_eitu709_full[3][4] = {
...
static __maybe_unused const u16 csc_coeff_rgb_full_to_bt2020_full[3][4] = {
...
static void dw_hdmi_update_csc_coeffs(struct dw_hdmi *hdmi)
{
	...
	if (!is_input_rgb && is_output_rgb) {
		...
		if (hdmi->hdmi_data.enc_out_encoding == V4L2_YCBCR_ENC_601)
			csc_coeff = &csc_coeff_rgb_full_to_eitu601_limited;
		else if (hdmi->hdmi_data.enc_out_encoding == V4L2_YCBCR_ENC_BT2020)
			csc_coeff = &csc_coeff_rgb_full_to_bt2020_limited;
		else
			csc_coeff = &csc_coeff_rgb_full_to_eitu709_limited;
		csc_scale = 0;
	} else if (is_input_rgb && is_output_rgb &&
