 ...
 * V0.0X01.0X0d add support for 2lane 50fps setting
 */
...
#define PIXEL_RATE_WITH_540M_10BIT_2L	(SC450AI_LINK_FREQ_540 * 2 / \
					SC450AI_BITS_PER_SAMPLE * 2)
/* 4 lane */
 ...
 */
static const struct regval sc450ai_linear_10_2560x1440_50fps_2lane_regs[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x36f9, 0x80},
...
static int sc450ai_initialize_controls(struct sc450ai *sc450ai)
{
	...
	if (lanes == 4)
		...
		sc450ai->pixel_rate = v4l2_ctrl_new_std(handler, NULL, V4L2_CID_PIXEL_RATE,
				0, PIXEL_RATE_WITH_540M_10BIT_2L, 1, dst_pixel_rate);
